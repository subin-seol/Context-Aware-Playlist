 ...
 *
 * Also includes a small permission helper (Perms) so the first GO click can
 * prompt for ACTIVITY_RECOGNITION + LOCATION in one place.
 */
public final class AppEvents {
    ...
    /** Ask the service to perform an immediate 5-second measuring window. */
